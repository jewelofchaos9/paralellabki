...
По вышеуказанным причинам график ускорения имеет пилообразную форму
<h3>Как оптимизировать алгоритм, чтобы он завершался, если один из потоков найдет индекс элемента?</h3>
Можно добавить #pragma cancel for. Так как на случайных числах довольно редко находится элемент различия в графиках минимальны. <br>
На графике acceleration при использовании ~14 потоков, можно заметить небольшую разницу, при использовании cancel, ускорение чуть больше. 
<br><br>
